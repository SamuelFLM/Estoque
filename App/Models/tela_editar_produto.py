...
def TelaEditarProduto(api, item):
    bg_color = "#FFFFFF"
    text_color = "#414141"
    ...
    window["ipt_produto"].update(item[1])
    window["ipt_marca"].update(item[2])
    window["ipt_preco"].update(item[3])
    window["ipt_validade"].update(item[4])
